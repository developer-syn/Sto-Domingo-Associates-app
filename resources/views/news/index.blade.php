...
@section('content')
    ...
    <!-- Add News Button -->
    <button id="openNewsModal" class="btn btn-primary d-flex align-items-center mb-3"
    ...
    <!-- Add News Modal -->
    <div class="modal fade" id="newsModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="newsModalLabel">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content shadow-lg">
                <div class="modal-header" style="background-color: rgb(212, 6, 16); color: #fff;">
                    <h5 class="modal-title w-100 text-center" id="newsModalLabel">Add New News</h5>
    ...
    <!-- Edit News Modal -->
    <div class="modal fade" id="editNewsModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="editNewsModalLabel">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content shadow-lg">
                <div class="modal-header" style="background-color: rgb(212, 6, 16); color: #fff;">
                    <h5 class="modal-title w-100 text-center" id="editNewsModalLabel">Edit News</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    .btn-danger:hover {
        background-color: rgb(180, 4, 12) !important;
