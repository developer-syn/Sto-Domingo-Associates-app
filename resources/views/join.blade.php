        ...
        <section class="section1">
            <div class="container1">
                <div class="part1">
                    ...
                    <form action="{{ route('submit') }}" method="POST" id="form" class="needs-validation">
                        @csrf
                            ...
                            <div class="c1-p1" id="manager-field" style="display: none; flex: 1;">
                                ...
                                <select name="manager_type" class="manager" id="manager">
                                    ...
                                    @foreach ($managerProfiles as $manager)
                                        <option value="{{ $manager->name }}" data-branch="{{ $manager->branch }}"
                                            data-specify-branch="{{ $manager->specify_branch }}">
                                            {{ $manager->name }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="c1">
                            ...
                            <div class="c1-p1 specify-branch" style="display: none; flex: 1;">
                                ...
                                <select name="specify_branch" id="specify-branch" class="branch">
                                    ...
                                    @foreach ($managerProfiles->unique('branch') as $branch)
                                        <option value="{{ $branch->branch }}" data-branch="{{ $branch->branch }}">
                                            {{ $branch->branch }}
                                        </option>
                                    @endforeach
                                </select>
