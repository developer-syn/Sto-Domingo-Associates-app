...
<body>
    ...
    <div class="container" id="login" style="background-image: url('{{asset('css/images/cebu-building.png')}}'); display: flex">
        <div class="modal" id="loginModal">
            <div class="modal-container">
                <div class="modal-left">
                    <h1 style="padding-bottom: 15px" class="modal-title">Welcome!</h1>
                ...
                <div class="modal-right">
                    <div class="slideshow">
                        <img src="{{asset('css/images/sec4-image1.jpg')}}" alt="Additional Image" class="slide">
                        <img src="{{asset('css/images/SDA.png')}}" alt="SDA Logo" class="slide">
