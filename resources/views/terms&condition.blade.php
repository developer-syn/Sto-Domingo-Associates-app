        ...
        <div id="header-content">
            ...
            <nav class="navigation">
                ...
                <ul id="nav-list" class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('display-news') }}" class="nav-link">News & Media</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('organization') }}" class="nav-link">Organization</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('about') }}" class="nav-link">About</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('join') }}" class="nav-link">Join Now</a>
                    </li>
                </ul>
            </nav>
        </div>
