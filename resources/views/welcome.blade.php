...
<main class="main">
    <section class="section1">
        ...
        <div class="container">
            <div class="slides">
                <div class="slide">
                    <img src="{{ asset('css/images/slide1.jpg') }}" alt="">
                    <div>
                ...
                <div class="slide">
                    <img src="{{ asset('css/images/slide2.png') }}" alt="">
                    <div>
                ...
                <div class="slide">
                    <img src="{{ asset('css/images/slide3.jpg') }}" alt="">
                    <div>
                ...
                <div class="slide">
                    <img src="{{ asset('css/images/slide4.jpg') }}" alt="">
                    <div>
            ...
            <div class="slide-controls">
                <button id="prev-btn"><img src="{{ asset('css/images/prev-button.png') }}"></button>
                <button id="next-btn"><img src="{{ asset('css/images/next-button.png') }}"></button>
            </div>
        </div>
    </section>
        ...
        <div class="sec2-container">
            ...
            <div class="sec2-image-container" id="imageContainer">
                <div class="sec2-image">
                    <img src="{{ asset('css/images/sec2-image1.jpg') }}" alt="Service image 1" loading="lazy">
                    <div class="image-overlay">
                    </div>
                </div>
                <div class="sec2-image">
                    <img src="{{ asset('css/images/sec2-image2.jpg') }}"alt="Service image 2" loading="lazy">
                    <div class="image-overlay">
                    </div>
                </div>
                <div class="sec2-image">
                    <img src="{{ asset('css/images/sec2-image3.jpg') }}" alt="Service image 3" loading="lazy">
                    <div class="image-overlay">
                    </div>
                </div>
            </div>
    ...
    {{-- <section class="section2">
        <div class="sec2-container">
            <div class="sec2-intro">
                <p>More Than <span>19</span> Years of Service of Excellence</p>
            </div>
            <div class="sec2-image-container">
                <div class="sec2-image1"><img src="{{ asset('css/images/sec2-image1.jpg') }}" alt=""></div>
                <div class="sec2-image2"><img src="{{ asset('css/images/sec2-image2.jpg') }}" alt=""></div>
                <div class="sec2-image3"><img src="{{ asset('css/images/sec2-image3.jpg') }}" alt=""></div>
            </div>
        </div>
    </section> --}}
    ...
    <section class="section3">
        <div class="sec3-content1">
            <div class="image1"
                style="  background-image: url('{{ asset('css/images/sec3-image1.jpg') }}'); background-size: cover;">
                <div class="overlay"></div>
                <p class="sec3-intro">
                    Are You A Recent Graduate Or A Seasoned Professional Seeking Career Growth?
                </p>
                <h1 class="join">
                    {{-- <a href="{{ route('join') }}">JOIN US NOW!!!</a> --}}
                    <a href="{{ route('join') }}">JOIN US NOW!!!</a>
                    <br>
                    <span class="join1">
        ...
        <div class="sec4-contents">
            ...
            <div class="sec4-images">
                <div class="sec4-image1"><a href="https://www.aia.com.ph/en/" target="_blank"><img
                            src="{{ asset('css/images/sec4-image1.jpg') }}"></a></div>
            </div>
        </div>
    </section>
</main>
...
<footer class="footer">
    ...
    <div class="footer-bottom">
        ...
        <div class="social-icons">
            <a href="{{ route('admin_login') }}" class="icon admin">
                <img src="{{ asset('css/images/admin_icon_2.jpg') }}" alt="Admin" class="admin-icon">
