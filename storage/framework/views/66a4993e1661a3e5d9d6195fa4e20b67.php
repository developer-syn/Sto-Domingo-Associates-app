...
<head>
    ...
    <title>Sto. Domingo Associates | terms & Condition</title>

    <!-- Fonts -->
    <link rel="preconnect" href="https://fonts.bunny.net">
    <link href="https://fonts.bunny.net/css?family=figtree:400,600&display=swap" rel="stylesheet" />
    <link rel="icon" href="<?php echo e(asset('css/images/SDALOGO.png')); ?>" type="image/png" />
    <link rel="stylesheet" href="<?php echo e(asset('css/term.css')); ?>">
...
<body>
    ...
    <main class="main">
        <div class="terms-container">
            <h3><strong>Welcome to Sto. Domingo Associates Agency!</strong></h3>
            <br>
            <p>These terms and conditions outline the rules and regulations for the use of Santo Domingo Associates
                Agency's
                Website, located at http://127.0.0.1:5500/index.html#.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                Sto.
                Domingo Associates Agency if you do not agree to take all of the terms and conditions stated on this
                page.</p>
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                ...
                the
                Company's stated services, in accordance with and subject to, prevailing law of ph. Any use of the
                above
                terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken
                as
                interchangeable and therefore as referring to same.</p>

            <h3><strong>Cookies</strong></h3>
            <br>
            <p>We employ the use of cookies. By accessing Sto. Domingo Associates Agency, you agreed to use cookies
                in
                agreement with the Santo Domingo Associates Agency's Privacy Policy. </p>

            <p>Most interactive websites use cookies to let us retrieve the user's details for each visit. Cookies
                are used
                by our website to enable the functionality of certain areas to make it easier for people visiting
                our website.
                Some of our affiliate/advertising partners may also use cookies.</p>
            <br>
            <h3><strong>License</strong></h3>
            <br>
            <p>Unless otherwise stated, Santo Domingo Associates Agency and/or its licensors own the intellectual
                property
                rights for all material on Sto. Domingo Associates Agency. All intellectual property rights are
                reserved. You
                may access this from Sto. Domingo Associates Agency for your own personal use subjected to
                restrictions set in
                these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Sto. Domingo Associates Agency</li>
                <li>Sell, rent or sub-license material from Sto. Domingo Associates Agency</li>
                <li>Reproduce, duplicate or copy material from Sto. Domingo Associates Agency</li>
                <li>Redistribute content from Sto. Domingo Associates Agency</li>
            </ul>
            <br>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain
                areas of the website. Santo Domingo Associates Agency does not filter, edit, publish or review
                Comments prior
                to their presence on the website. Comments do not reflect the views and opinions of Santo Domingo
                Associates
                Agency,its agents and/or affiliates. Comments reflect the views and opinions of the person who post
                their
                views and opinions. To the extent permitted by applicable laws, Santo Domingo Associates Agency
                shall not be
            ...
            <p>Santo Domingo Associates Agency reserves the right to monitor all Comments and to remove any Comments
                which
            ...
            <br>
            <p>You hereby grant Santo Domingo Associates Agency a non-exclusive license to use, reproduce, edit and
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                ...
                of Santo
                Domingo Associates Agency; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website,
                you must inform us by sending an e-mail to Santo Domingo Associates Agency. Please include your
                name, your
            ...
            <p>No use of Santo Domingo Associates Agency's logo or other artwork will be allowed for linking absent
                a
        ...
        <div id="header-content">
            ...
            <nav class="navigation">
                ...
                <ul id="nav-list" class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('display-news')); ?>" class="nav-link">News & Media</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(route('organization')); ?>" class="nav-link">Organization</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(route('about')); ?>" class="nav-link">About</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(route('join')); ?>" class="nav-link">Join Now</a>
                    </li>
                </ul>
            </nav>
        </div>
...
<?php /**PATH C:\Users\User\Desktop\Sto-Domingo-Associates-app\resources\views/terms&condition.blade.php ENDPATH**/ ?>