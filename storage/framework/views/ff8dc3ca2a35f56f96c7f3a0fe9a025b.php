        ...
        <div id="branchManagerModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
            <div class="bg-white p-4 rounded-lg shadow-md" style="width: 450px;">
                ...
                <form id="branchManagerForm" action="<?php echo e(route('members.storeManagerProfile')); ?>" method="POST"
                    ...
                    <input type="hidden" name="branch" value="pampanga">
...
<?php echo $__env->make('admin.members', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\Sto-Domingo-Associates-app\resources\views/admin/members/pampanga.blade.php ENDPATH**/ ?>