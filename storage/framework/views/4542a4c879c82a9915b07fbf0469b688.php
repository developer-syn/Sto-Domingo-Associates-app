    ...
    <main class="main">
        <section class="ssection1">
            <nav>
                ...
                <ul>
                    <li>
                        <a href="<?php echo e(route('display-news')); ?>?category=news"
                            class="<?php echo e($category == 'news' ? 'active' : ''); ?>" id="button1">
                            News
                            <i class="ri-newspaper-line"></i>
                            <span class="label" id="news-num"><?php echo e(count($news)); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('display-news')); ?>?category=events"
                            class="<?php echo e($category == 'events' ? 'active' : ''); ?>" id="button2">
                            Events
                            <i class="ri-calendar-event-line"></i>
                            <span class="label" id="events-num"><?php echo e(count($events)); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('display-news')); ?>?category=triumphs"
                            class="<?php echo e($category == 'triumphs' ? 'active' : ''); ?>" id="button3">
                            Triumphs
                            <i class="ri-medal-line"></i>
                            <span class="label" id="achievements-num"><?php echo e(count($triumphs)); ?></span>
                        </a>
                    </li>
                </ul>
            </nav>
            ...
            <div id="content" class="news-list">
                ...
                <?php elseif($category == 'events'): ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php elseif($category == 'triumphs'): ?>
                    <?php $__currentLoopData = $triumphs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="embed-code">
                            <?php echo $item->embed_code; ?>
        ...
        <section class="section2">
            ...
            <div class="video-container">
                <video width="100%" height="100%" controls autoplay loop muted>
                    <source src="<?php echo e(asset('css/video/SdaVideo.mp4')); ?>" type="video/mp4">
                </video>
            </div>
        </section>
    </main>
...
<?php /**PATH C:\Users\User\Desktop\Sto-Domingo-Associates-app\resources\views/display-news.blade.php ENDPATH**/ ?>